...
Object a1 = (org.nvd.json.jsoniter.reduced.ProblemtypeDatum)jsoniter_codegen.cfg9223372036100299902.decoder.org.nvd.json.jsoniter.reduced.ProblemtypeDatum.decode_(iter);
...
Object a2 = (org.nvd.json.jsoniter.reduced.ProblemtypeDatum)jsoniter_codegen.cfg9223372036100299902.decoder.org.nvd.json.jsoniter.reduced.ProblemtypeDatum.decode_(iter);
if (com.jsoniter.CodegenAccess.nextToken(iter) != ',') {
...
Object a3 = (org.nvd.json.jsoniter.reduced.ProblemtypeDatum)jsoniter_codegen.cfg9223372036100299902.decoder.org.nvd.json.jsoniter.reduced.ProblemtypeDatum.decode_(iter);
if (com.jsoniter.CodegenAccess.nextToken(iter) != ',') {
...
Object a4 = (org.nvd.json.jsoniter.reduced.ProblemtypeDatum)jsoniter_codegen.cfg9223372036100299902.decoder.org.nvd.json.jsoniter.reduced.ProblemtypeDatum.decode_(iter);
...
obj.add((org.nvd.json.jsoniter.reduced.ProblemtypeDatum)jsoniter_codegen.cfg9223372036100299902.decoder.org.nvd.json.jsoniter.reduced.ProblemtypeDatum.decode_(iter));
}
return obj;
