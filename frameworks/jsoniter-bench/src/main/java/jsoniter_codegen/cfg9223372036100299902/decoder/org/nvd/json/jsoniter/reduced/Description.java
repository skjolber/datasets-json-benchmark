...
public class Description implements com.jsoniter.spi.Decoder {
...
if (nextToken != '"') {
if (nextToken == '}') {
return (existingObj == null ? new org.nvd.json.jsoniter.reduced.Description() : (org.nvd.json.jsoniter.reduced.Description)existingObj);
} else {
nextToken = com.jsoniter.CodegenAccess.nextToken(iter);
if (nextToken == '}') {
return (existingObj == null ? new org.nvd.json.jsoniter.reduced.Description() : (org.nvd.json.jsoniter.reduced.Description)existingObj);
...
java.util.List _descriptionData_ = null;
do {
switch (com.jsoniter.CodegenAccess.readObjectFieldAsHash(iter)) {
case 1831987666: 
_descriptionData_ = (java.util.List)jsoniter_codegen.cfg9223372036100299902.decoder.java.util.List_org.nvd.json.jsoniter.reduced.LangString.decode_(iter);
continue;
}
iter.skip();
} while (com.jsoniter.CodegenAccess.nextTokenIsComma(iter));
org.nvd.json.jsoniter.reduced.Description obj = (existingObj == null ? new org.nvd.json.jsoniter.reduced.Description() : (org.nvd.json.jsoniter.reduced.Description)existingObj);
obj.setDescriptionData(_descriptionData_);
return obj;
