...
jsoniter_codegen.cfg9223372036100299902.encoder.org.nvd.json.jsoniter.reduced.ProblemtypeDatum.encode_((org.nvd.json.jsoniter.reduced.ProblemtypeDatum)e, stream);
stream.write((byte)'}');
}
